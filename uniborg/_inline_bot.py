...
Press the buttons below for more information""",
                buttons=[
                    ...
                    [custom.Button.url("🌍Tutorial🌍", "https://telegra.ph/Tutorial-07-23"), custom.Button.text("❌DISCLAIMER❌", "Neither this channel nor its creator is responsible for any damage or loss incurred by the use of this software.")]
                ],
                link_preview=False
            )
